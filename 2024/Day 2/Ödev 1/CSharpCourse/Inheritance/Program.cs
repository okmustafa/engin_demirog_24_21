...
namespace Inheritance   //46.Video Kalıtıma Giriş
{
    class Program 
    {
    ...
    //************************************************//class Customer : Person ,Person2  yapamayız yani
    ...
    {                         // Yani IPerson,IPerson2 filan diye ekleyebilirim.
        ...
        // Eğer İnheritance kullanmaya gerek yok diye düşünüyorsan zorunlu değilsen interfaceden gitmeye çalış.
